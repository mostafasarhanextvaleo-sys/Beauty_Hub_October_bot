...
const MESSAGES = {
  ...
  askSkinType: 'تمام يا قمر، بشرتك دهنية ولا جافة ولا مختلطة؟ عشان أرشحلك حاجة مناسبة.',
  ...
  orderCompleted:
    'تمام يا قمر، طلبك اتسجل وهيتم التواصل معاكي لتأكيد التوصيل قريب 🌸 شكراً لثقتك في Beauty Hub October.',

  orderCancelled:
    'ولا يهمك يا قمر 🌸 لو حبيتي تسألي على حاجة تانية أنا موجودة في أي وقت.',
  ...
  stillDeciding:
    'خدي وقتك يا قمر 🌸 لو حابة تسألي أي سؤال تاني عن المنتج أنا موجودة.',

  fallback:
    'تحت أمرك يا قمر 🌸 قوليلي محتاجة مساعدة في إيه، بشرة ولا شعر ولا ميكب ولا حاجة تانية؟',
...
function orderConfirmationSummary({ productName, customerName, deliveryAddress }) {
  return (
    'تمام يا قمر 🌸 خليني أتأكد من البيانات:\n' +
