...
async function handleOrderConfirmed(chatId, { customerName, phone, address, products, totalPrice, shippingMethod, quantity, locationLink }) {
  let appended = null;
  ...
  try {
    await runExclusive(chatId, async () => {
      ...
      if (openDraft && products && !openDraft.products.includes(products)) {
        ...
        appended = await googleSheets.appendConfirmedOrder({ customerName, phone, address, products, totalPrice, shippingMethod, quantity, locationLink });
      }
